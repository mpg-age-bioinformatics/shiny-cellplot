...
shinyUI( fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      helpText(a(href = "https://raw.githubusercontent.com/mpg-age-bioinformatics/shiny-cellplot/master/DAVIDws.CLL.cellplot.FunctionalAnnotation.398ecca.tsv", "Example input")),
      hr(),
      ...
      helpText(a(href = "https://raw.githubusercontent.com/mpg-age-bioinformatics/shiny-cellplot/master/ref.values.tsv", "Example input")),
      hr(),
